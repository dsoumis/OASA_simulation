...
<body onload="Initialize()">
    ...
    <rav>   Καλωσορίσατε στην διαδικτυακή σελίδα του ΟΑΣΑ. <br>
        ...
        <a class="nav-link" href="./">Μπορείτε να περιηγηθείτε σε όλες τις διαδρομές που σας προσφέρει <br> ο ΟΑΣΑ</a> 
        <a class="nav-link" href="./"> καθώς και να αναζητήσετε τη συντομότερη διαδρομή για να φτάσετε στον προορισμό σας.<br> </a>
        <a class="nav-link" href="./">Ακόμα, σεβόμενοι απόλυτα τις ανάγκες κάθε πολίτη ξεχωριστά, δίνουμε <br>
